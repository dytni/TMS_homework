...
public class lesson_6_task_3 {
     public static void main(String[] args) {
         ...
         Product_Document product_document = new Product_Document(date,12,12,"sdfdhgj");
         Worker_Contract_Document worker_contract_document= new Worker_Contract_Document(12,date, date, "dgfcs");
