...
public class Vector3 {
    ...
    int vectorScalar(Vector3 vector3) {
        if (vector3 == null) throw new IllegalArgumentException("Error argument");
        return x * vector3.x + y * vector3.y + z * vector3.z;
    }

    Vector3 vectorSum(Vector3 vector3) {
        if (vector3 == null) throw new IllegalArgumentException("Error argument");
        return new Vector3(x + vector3.x,
                y + vector3.y, z + vector3.z);
    }

    Vector3 vectorDiff(Vector3 vector3) {
        if (vector3 == null) throw new IllegalArgumentException("Error operator");
        return new Vector3(x - vector3.x, y - vector3.y, z - vector3.z);
    }

    static Vector3[] vector3s(int n) {
    ...
    Boolean vectorIsLonger(Vector3 vector3) {
        if (vector3 == null) throw new IllegalArgumentException("Error operator");
