...
public class Money {
    ...
    public void setCount(int count, Denomination denomination){
        ...
        if(denomination==Denomination.DOLLAR_50)denominations[1].changeCount(count);

        if(denomination==Denomination.DOLLAR_100)denominations[2].changeCount(count);
    }
    public void addCount(int count,Denomination denomination){
        ...
        if(denomination==Denomination.DOLLAR_50)denominations[1].addCount(count);

        if(denomination==Denomination.DOLLAR_100)denominations[2].addCount(count);
    }
